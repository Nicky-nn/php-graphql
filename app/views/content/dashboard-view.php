<div class="container is-fluid">
	...
	<div class="columns is-flex is-justify-content-center">
		<p class="subtitle">
			<i class="fas fa-store"></i> &nbsp; Tienda: <span id="tienda"></span>
		</p>
	</div>

	<!-- Agregar un scrip donde recuperemos del localstorage -->
	<script>
		var user = localStorage.getItem('isipass_tienda');
		document.getElementById('tienda').innerHTML = user;
		var token = localStorage.getItem('isipass_token');
	</script>
